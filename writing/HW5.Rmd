...
I think it would be fun to use Baton Rouge. Next, I'm going to create an object containing just the observations for Baton Rouge. I also need to create a variable for solved/unsolved homicides, and save as an sf object so I can plot this on a map.
