...
To perform the analysis, open HW5.Rmd in the subdirectory /writing. 

Data used for the analysis is contained inside the /data subdirectory, 
in the file "homicide-data.csv". Data was accessed from the Washington Post's Github page at 
"https://github.com/washingtonpost/data-homicides". 

Information on the dataset from the Washington Post: 
